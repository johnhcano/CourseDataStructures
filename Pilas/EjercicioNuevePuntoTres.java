...
public class EjercicioNuevePuntoTres {
     ...
     * caracteres de una expresión que viene dada en una línea. 
     * La finalidad es verificar el equilibrio de paréntesis, llaves y corchetes. 
     * Por ejemplo, la siguiente expresión tiene un número de
